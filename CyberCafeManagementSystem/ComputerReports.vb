...
Public Class ComputerReports
    ...
    Private Sub ComputerReports_FormClosing(ByVal sender As System.Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles MyBase.FormClosing
        Me.Hide()
        frmMain.Show()
    End Sub

    Private Sub ComputerReports_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Public Function GetData() As DataView
        Dim SelectQry = "SELECT (COMPUTERNAME) AS [COMPUTERNAME],(COMPUTERLOCATION) AS [COMPUTER LOCATION],(IDADDRESS) AS [ID ADDRESS] FROM COMPUTER"
    ...
    Private Sub TextBox1_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TextBox1.TextChanged
        Try
            ...
            con.Open()
            cmd = New OleDbCommand("SELECT (COMPUTERNAME) AS [COMPUTERNAME],(COMPUTERLOCATION) AS [COMPUTER LOCATION],(IDADDRESS) AS [ID ADDRESS] FROM COMPUTER WHERE COMPUTERNAME LIKE '" & TextBox1.Text & "%' ORDER BY IDADDRESS", con)
