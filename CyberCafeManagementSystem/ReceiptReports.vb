...
Public Class ReceiptReports
    ...
    Private Sub ReceiptReports_FormClosing(ByVal sender As System.Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles MyBase.FormClosing
        Me.Hide()
        frmMain.Show()
    End Sub

    Private Sub ReceiptReports_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Public Function GetData() As DataView
        Dim SelectQry = "SELECT (MEMBERNAME) AS [MEMBER NAME],(MEMBERID) AS [MEMBER ID],(INTIME) AS [IN TIME],(OUTTIME) AS [OUT TIME],(PRICE) AS [PRICE] FROM RECEIPT"
    ...
    Private Sub TextBox1_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles TextBox1.TextChanged
        Try
            ...
            con.Open()
            cmd = New OleDbCommand("SELECT (MEMBERNAME) AS [MEMBER NAME],(MEMBERID) AS [MEMBER ID],(INTIME) AS [IN TIME],(OUTTIME) AS [OUT TIME],(PRICE) AS [PRICE] FROM RECEIPT WHERE MEMBERNAME LIKE '" & TextBox1.Text & "%' ORDER BY MEMBERID", con)
